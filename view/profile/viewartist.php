<?php
if ($_SESSION['id'] == $_REQUEST['ref']) {
    header('location:index.php?controller=profile&action=u&ref=' . $_REQUEST['ref']);
}
...
<div class="row justify-content-md-center">
    ...
    <a href="index.php?controller=profile&action=c&ref=' . $_REQUEST['ref'] . '" class="mt-4 btn btn-outline-secondary">Send Offer</a>
    </div>
    </div>
</div>
');
